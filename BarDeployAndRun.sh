...
sshpass -p "qwerty" ssh sd105@l040101-ws09.ua.pt 'cd test/Restaurant/dirBar ; java serverSide.main.ServerBar 22154 l040101-ws07.ua.pt 22153 l040101-ws06.ua.pt 22152'